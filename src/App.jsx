...
*/
  ...
  return (
    <>
      <section className="bg-rose1 w-full h-screen flex justify-center lg:pt-24">
        <div className=" bg-white w-1/2 margin-auto flex flex-col border" >
          <img src="/image-omelette.jpeg" className="object-contain" alt="omelette" />
